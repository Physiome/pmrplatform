...
strings:l,keywords:u}}}})();hljs.registerLanguage("c",e)})();/*! `fortran` grammar compiled for Highlight.js 11.10.0 */
...
relevance:0},a,c]}}})();hljs.registerLanguage("fortran",e)})();/*! `matlab` grammar compiled for Highlight.js 11.10.0 */
...
;hljs.registerLanguage("matlab",e)})();/*! `python` grammar compiled for Highlight.js 11.10.0 */
...
;hljs.registerLanguage("python",e)})();/*! `c` grammar compiled for Highlight.js 11.10.0 */
(()=>{var e=(()=>{"use strict";return e=>{const n=e.regex,t=e.COMMENT("//","$",{
contains:[{begin:/\\\n/}]
}),a="decltype\\(auto\\)",s="[a-zA-Z_]\\w*::",i="("+a+"|"+n.optional(s)+"[a-zA-Z_]\\w*"+n.optional("<[^<>]+>")+")",r={
className:"type",variants:[{begin:"\\b[a-z\\d_]*_t\\b"},{
